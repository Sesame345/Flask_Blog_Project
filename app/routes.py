#the order of imports isit important 
import os
import secrets
...
def home():
    ...
    return render_template ('home.html', posts=posts, map_class= map_class,)
...
def map():
    map_class = "map"
    return render_template ('map.html', title = 'maps', map_class= map_class)
...
def login():
    ...
    if form.validate_on_submit():
      ...
      if user and bcrypt.check_password_hash(user.password,form.password.data):
       ...
       flash('Login Unsuccessful. Please Check youremail and password', 'danger')
...
def new_post():
 ...
 if form.validate_on_submit():
   ...
   return redirect(url_for ('home'))
 return render_template('create_post.html', title='New Post',form=form, legend='Create Post', map_class= map_class )
